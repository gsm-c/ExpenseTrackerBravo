...
public class DatabaseManager {
    private static final String DB_URL = "jdbc:mysql://localhost:3306/expense_tracker_db?allowPublicKeyRetrieval=true&useSSL=false";
    private static final String DB_USER = "tracker_user";
    private static final String DB_PASSWORD = "tracker_pass";
    ...
    public static UserReport generateUserReport(int userId) {
        ...
        List<Transaction> recentTransactions = getRecentTransactions(userId, 10);
    ...
    public static double getTotalBalance(int userId) {
        return getTotal(userId, "income") - getTotal(userId, "expense");
    }
